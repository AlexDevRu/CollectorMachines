...
{
    /// <summary>
    /// Логика взаимодействия для SectionLoop.xaml
    /// </summary>
    public partial class SectionLoop : UserControl
    {
        public SectionLoop(Grid grid)
        {
            InitializeComponent();
            close.Click += (s, e) => grid.Children.Remove(this);
